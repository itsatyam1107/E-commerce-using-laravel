...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item admin-only">
                    <a class="nav-link" href="#">Activity</a></li>
                <li class="nav-item user-only">
    ...
    <div class="hero-section">
        ...
        <div class="image-slider">
            ...
            <img src="https://images.unsplash.com/3/www.madebyvadim.com.jpg?q=80&w=1782&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Slider Image 3">
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Simulate user type (this should come from your backend)
